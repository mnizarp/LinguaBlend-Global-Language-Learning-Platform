...
//     <input onChange={(e) => setSearchInput(e.target.value)} value={searchInput} className='h-full w-full focus:outline-none' placeholder='Search people....' />
//   </div>
...
//               <div
//                 key={user?._id}
//                 onClick={() => navigate('/profilepage', { state: { user: user?._id } })}
...
//             <button onClick={()=>setPostImageSettingBox(false)} className="bg-red-500  font-semibold text-sm py-1 px-2 text-white rounded-md">Cancel</button>
