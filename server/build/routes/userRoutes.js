...
userRouter.post('/resendotp', userAuthController_1.resendOtp);
userRouter.post('/clearotp', userAuthController_1.clearOtp);
...
userRouter.post('/savepost', authMiddleware_1.protect, postControllers_1.savePost);
userRouter.post('/unsavepost', authMiddleware_1.protect, postControllers_1.unsavePost);
userRouter.post('/logout', userAuthController_1.logout);
userRouter.post('/checksaved', authMiddleware_1.protect, postControllers_1.checkSaved);
userRouter.get('/getsavedposts', authMiddleware_1.protect, postControllers_1.get_saved_posts);
userRouter.post('/contactadmin', userAuthController_1.contactAdmin);
